...
import 'package:catalyst_technical_task/Features/Display_Edit_Create_Bookings/Presentation/views/EditBooking.dart';
...
Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => EditBooking(booking: booking),
          ),
        );
      },
      child: Card(
